(function() {
  ...
  _.filter = function(collection, test) {
    //Create new array for values that pass
    var passed = [];
    //Iterate through all values in collection
    _.each(collection, function(value) {
      //Check if it passes test
      if(test(value)) {
        //Push to new array if passed
        passed.push(value);
      }
    });
    //return new array
  ...
  _.every = function(collection, iterator) {
    // Checks if iterator has a value. If not sets it to it self with identity method
    var hasIterator = iterator || _.identity;
    //Pass collection, an iterator, and accumulator to reduce
    return _.reduce(collection, function(isTrue, item) {
      if(hasIterator(item) && isTrue) {
        return true;
      } else {
        return false;
      }
  ...
  _.memoize = function(func) {
    ...
    return function() {
      ...
      return (args in result) ? result[args] : result[args] = func.apply(this, arguments); 
    }
  };
